...
class Transmission extends \Magento\Framework\App\Action\Action
{
    /**
     * Glass Factory
     * 
    ...
    public function execute()
    {
        ...
        $variantCollection->addFieldToSelect('glass_transmission');
        ...
        $variantCollection->getSelect()->group('glass_transmission')->order('glass_transmission ASC');
        //print_r($years);
		...
		if ($variantCollection) {
       		...
       		foreach ($variantCollection->getData() as $variant) {
                //print_r($year);
                $variants[]['glass_transmission'] = trim($variant['glass_transmission']);
        	}
