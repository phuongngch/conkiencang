...
class Month extends \Magento\Framework\App\Action\Action
{
    /**
     * Glass Factory
     * 
    ...
    public function execute()
    {
        ...
        $variantCollection->addFieldToSelect('glass_mth');
        ...
        $variantCollection->getSelect()->group('glass_mth')->order('glass_mth ASC');
        //print_r($years);
		...
		if ($variantCollection) {
       		...
       		foreach ($variantCollection->getData() as $variant) {
                //print_r($year);
                $variants[]['glass_mth'] = trim($variant['glass_mth']);
        	}
